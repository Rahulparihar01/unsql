...
let chatClassName = 'g-chat-opened';
...
if (chatDropDown) {
  chatDropDown.addEventListener("click", toggleChatDropDown);
}
...
function toggleChatDropDown() {
  if (body.classList.contains(chatClassName)) {
    body.classList.remove(chatClassName);
    setTimeout(function() {
      sidenav.classList.remove('bg-white');
    }, 100);
    sidenav.classList.remove('bg-transparent');
    ...
    body.classList.add(chatClassName);
    sidenav.classList.add('bg-white');
    sidenav.classList.remove('bg-transparent');
    iconSidenav.classList.remove('d-none');
  }
...
function darkMode(el) {
  ...
  if (el.classList.contains('fa-sun')) {
    ...
    if (document.getElementById('editModalStyle'))
      document.getElementById('editModalStyle').classList.add('dark-version')
    if (document.getElementById('deleteModalStyle'))
      document.getElementById('deleteModalStyle').classList.add('dark-version')
  } else {
    el.classList.add('fa-sun')
    el.classList.remove('fa-moon')
    localStorage.setItem('darkmode',false)
    if (document.getElementById('editModalStyle'))
      document.getElementById('editModalStyle').classList.remove('dark-version')
    if (document.getElementById('deleteModalStyle'))
      document.getElementById('deleteModalStyle').classList.remove('dark-version')
  }
