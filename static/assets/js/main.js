...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#container13 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in', speed: 1000, intensity: 3, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, replay: false });
		onvisible.add('#container14', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#container02', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, staggerOrder: '', replay: false });
